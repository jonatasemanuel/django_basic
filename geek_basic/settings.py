"""
Django settings for geek_basic project.
...
ALLOWED_HOSTS = ['https://git.heroku.com/storebasic-je.git']
...
WSGI_APPLICATION = 'geek_basic.wsgi.application'
